...
<div class="matrix-row lightbox">
  {{import '_inlineimg' forced=true images['01-1'] alt="SMITH: The orders were for your protection."}}
  {{import '_inlineimg' forced=true images['01-2'] alt="COP: I think we can handle one little girl."}}
  {{import '_inlineimg' forced=true images['01-3'] alt="SMITH: No, lieutenant, your men are already dead."}}
</div>
}!}
...
{!{
<div class="matrix-row lightbox">
  {{import '_inlineimg' forced=true images['02-1'] alt="Trinity leaps into the air, the film pausing to pan around her frozen mid leap, preparing to kick a policeman."}}
  {{import '_inlineimg' forced=true images['02-2'] alt="Trinity leaps from rooftop to rooftop, spanning an entire street."}}
  {{import '_inlineimg' forced=true images['02-3'] alt="Trinity dives through the air, her body straight as an arrow, to narrowly break through a tiny window."}}
</div>
}!}
...
{!{
<div class="matrix-row lightbox">
   {{import '_inlineimg' images['03-0'] alt="JONES: The informant is real. SMITH: Yes" size="768w"}}
</div>
}!}
...
{!{
<div class="matrix-row lightbox">
  {{import '_inlineimg' images['04-1'] alt=""}}
  {{import '_inlineimg' images['04-2'] alt=""}}
  {{import '_inlineimg' images['04-3'] alt=""}}
</div>
}!}
...
{!{
<div class="matrix-row lightbox">
   {{import '_inlineimg' images['05-1'] alt=""}}
   {{import '_inlineimg' images['05-2'] alt="Wake up Neo."}}
   {{import '_inlineimg' images['05-3'] alt=""}}
</div>
}!}
...
{!{
<div class="matrix-row lightbox">
   {{import '_inlineimg' images['06-1'] alt=""}}
   {{import '_inlineimg' images['06-2'] alt=""}}
   {{import '_inlineimg' images['06-3'] alt=""}}
</div>
}!}
...
{!{
<div class="matrix-row lightbox">
   {{import '_inlineimg' images['07-1'] alt="Neo holds a book titled Simulacra and Simulation."}}
   {{import '_inlineimg' images['07-2'] alt="Opening the book reveals a hidden cavity at the chapter titled Nihilism"}}
   {{import '_inlineimg' images['07-3'] alt="NEO: Ever have that feeling where you're not sure if you're awake or dreaming?"}}
</div>
}!}
...
{!{
<div class="matrix-row lightbox">
   {{import '_inlineimg' images['08-1'] alt="Neo stands alone in a bondage and kink dance club"}}
   {{import '_inlineimg' images['08-2'] alt="TRINITY: Hello, Neo"}}
   {{import '_inlineimg' images['08-3'] alt="NEO: How do you know that name?"}}
</div>
}!}
...
{!{
<div class="matrix-row lightbox">
   {{import '_inlineimg' images['09-1'] alt="NEO: I just thought..."}}
   {{import '_inlineimg' images['09-2'] alt="NEO: ... you were a guy."}}
   {{import '_inlineimg' images['09-3'] alt="TRINITY: Most guys do."}}
</div>
}!}
...
{!{
<div class="matrix-row lightbox">
   {{import '_inlineimg' images['10-1'] alt="TRINITY: I know why you're here, Neo."}}
   {{import '_inlineimg' images['10-2'] alt="TRINITY: I know what you've been doing"}}
   {{import '_inlineimg' images['10-3'] alt="TRINITY: I know, because I was once looking for the same thing."}}
</div>
}!}
...
{!{
<div class="matrix-row lightbox">
   {{import '_inlineimg' images['11-1'] alt="External shot of the building Neo works in, a METACORTEX sign stretching vertically along its exterior"}}
   {{import '_inlineimg' images['11-2'] alt="RINEHEART: You have a problem with authority, Mr. Anderson."}}
   {{import '_inlineimg' images['11-3'] alt="RINEHEART: You believe that you are special, that the rules do not apply to you."}}
</div>
}!}
...
{!{
<div class="matrix-row lightbox">
   {{import '_inlineimg' images['12-0'] alt="RINEHEART: The time has come to make a choice, Mr. Anderson." size="768w"}}
</div>
}!}
...
{!{
<div class="matrix-row lightbox">
   {{import '_inlineimg' images['13-1'] alt="MESSENGER: Thomas Anderson?"}}
   {{import '_inlineimg' images['13-2'] alt="NEO: Yeah, that's me."}}
   {{import '_inlineimg' images['13-3'] alt="Neo looks down at the floor with a face of resigned discomfort."}}
</div>
}!}
...
{!{
<div class="matrix-row lightbox">
   {{import '_inlineimg' images['14-1'] alt="MORPHEUS: I don't know if you're ready to see what I want to show you."}}
   {{import '_inlineimg' images['14-2'] alt="MORPHEUS: But unfortunately, you and I have run out of time."}}
   {{import '_inlineimg' images['14-3'] alt="MORPHEUS: I can guide you, but you must do exactly as I say."}}
</div>
}!}
...
{!{
<div class="matrix-row lightbox">
   {{import '_inlineimg' images['15-0'] alt="MORPHEUS: They're coming for you, and I don't know what they're going to do."}}
</div>
}!}
...
{!{
<div class="matrix-row lightbox">
   {{import '_inlineimg' images['16-1'] alt="NEO: No way! No Way! This is crazy!"}}
   {{import '_inlineimg' images['16-2'] alt="NEO: Why is this happening to me?"}}
   {{import '_inlineimg' images['16-3'] alt="NEO: I can't do this."}}
</div>
}!}
...
{!{
<div class="matrix-row lightbox">
   {{import '_inlineimg' images['17-1'] alt="SMITH: As you can see, we've had our eye on you for some time now, Mr. Anderson."}}
   {{import '_inlineimg' images['17-2'] alt="SMITH: It seems that you've been living..."}}
   {{import '_inlineimg' images['17-3'] alt="SMITH: ...two lives."}}
</div>
}!}
...
{!{
<div class="matrix-row lightbox">
   {{import '_inlineimg' images['18-1'] alt="SMITH: One of these lives..."}}
   {{import '_inlineimg' images['18-2'] alt="SMITH: ...has a future."}}
   {{import '_inlineimg' images['18-3'] alt="SMITH: And one of them does not."}}
</div>
}!}
...
{!{
<div class="matrix-row lightbox">
   {{import '_inlineimg' images['19-0'] alt="Upside-down view of Smith's personal file for Thomas Anderson" size="768w"}}
</div>
}!}
...
{!{
<div class="matrix-row lightbox">
   {{import '_inlineimg' images['20-1'] alt="NEO (with a gun pointed at his head): What's this?"}}
   {{import '_inlineimg' images['20-2'] alt="TRINITY: It's necessary, Neo. For our protection."}}
   {{import '_inlineimg' images['20-3'] alt="NEO: From what?  TRINITY: From you."}}
</div>
}!}

{!{
<div class="matrix-row lightbox">
   {{import '_inlineimg' images['21-1'] alt="SWITCH: Right now, there's only one rule."}}
   {{import '_inlineimg' images['21-2'] alt="SWITCH: Our way..."}}
   {{import '_inlineimg' images['21-3'] alt="SWITCH: ...or the highway."}}
</div>
}!}
...
{!{
<div class="matrix-row lightbox">
   {{import '_inlineimg' images['22-1'] alt="TRINITY: Please, Neo, you have to trust me."}}
   {{import '_inlineimg' images['22-2'] alt="NEO: Why?  TRINITY: Because you have been down that road."}}
   {{import '_inlineimg' images['22-3'] alt="TRINITY: You know exactly where it ends."}}
</div>
}!}
...
{!{
<div class="matrix-row lightbox">
   {{import '_inlineimg' images['23-1'] alt="Ultrasound image of the machine's bug in Neo's abdomen."}}
   {{import '_inlineimg' images['23-2'] alt="NEO: Jesus Christ! That thing's real?"}}
   {{import '_inlineimg' images['23-3'] alt="Extracted bug, lying on the concrete outside the car, cast out."}}
</div>
}!}
...
{!{
<div class="matrix-row lightbox">
   {{import '_inlineimg' images['24-1'] alt="MORPHEUS: I can see it in your eyes."}}
   {{import '_inlineimg' images['24-2'] alt="MORPHEUS: You have the look of a man who accepts what he sees..."}}
   {{import '_inlineimg' images['24-3'] alt="MORPHEUS: Because he's expecting to wake up."}}
</div>
}!}
...
{!{
<div class="matrix-row lightbox">
   {{import '_inlineimg' images['25-1'] alt="MORPHEUS: You know something."}}
   {{import '_inlineimg' images['25-2'] alt="MORPHEUS: What you know, you can't explain."}}
   {{import '_inlineimg' images['25-3'] alt="MORPHEUS: But you feel it."}}
</div>
<div class="matrix-row lightbox">
   {{import '_inlineimg' images['25-4'] alt="MORPHEUS: You've felt it your entire life."}}
   {{import '_inlineimg' images['25-5'] alt="MORPHEUS: Something is wrong with the world. You don't know what, but it's there."}}
   {{import '_inlineimg' images['25-6'] alt="MORPHEUS: Like a splinter in your mind."}}
</div>
}!}
...
{!{
<div class="matrix-row lightbox">
   {{import '_inlineimg' images['26-1'] alt="MORPHEUS: Unfortunately, no one can be..."}}
   {{import '_inlineimg' images['26-2'] alt="MORPHEUS: ...told what the Matrix is."}}
   {{import '_inlineimg' images['26-3'] alt="MORPHEUS: You have to see it for yourself."}}
</div>
}!}
...
{!{
<div class="matrix-row lightbox">
   {{import '_inlineimg' images['27-1'] alt="MORPHEUS: You take the red pill..."}}
   {{import '_inlineimg' images['27-2'] alt="MORPHEUS: ...you stay in wonderland..."}}
   {{import '_inlineimg' images['27-3'] alt="MORPHEUS: ...and I show you how deep the rabbit hole goes."}}
</div>
}!}

{!{ {{import '~/img' images['27-4'] alt="Image of a Premarin 0.625mg pill. The pill is blood red." srcSizes="300px" className="card span3 right" }} }!}
...
{!{
<div class="matrix-row lightbox">
   {{import '_inlineimg' images['27-5'] alt="MORPHEUS: The pill you took is a trace program." size="768w"}}
</div>
}!}
...
{!{
<div class="matrix-row lightbox">
   {{import '_inlineimg' images['28-0'] alt="MORPHEUS: Time is always against us." size="768w"}}
</div>
}!}
...
{!{
<div class="matrix-row lightbox">
   {{import '_inlineimg' images['26-1'] alt="Neo looks at a broken mirror."}}
   {{import '_inlineimg' images['26-2'] alt="The cracks in the mirror begin to heal and smooth out."}}
   {{import '_inlineimg' images['26-3'] alt="The mirror is completely clear."}}
</div>
}!}
...
{!{
<div class="matrix-row lightbox">
   {{import '_inlineimg' images['30-1'] alt="MORPHEUS: Have you ever had a dream, Neo, that you were so sure was real?" size="576w"}}
   {{import '_inlineimg' images['30-2'] alt="MORPHEUS: What if you were unable to wake from that dream?" size="576w"}}
</div>
<div class="matrix-row lightbox">
   {{import '_inlineimg' images['30-3'] alt="MORPHEUS: How would you know the difference between the dream world..." size="576w"}}
   {{import '_inlineimg' images['30-4'] alt="MORPHEUS: ...and the real one?" size="576w"}}
</div>
}!}
...
{!{
<div class="matrix-row lightbox">
   {{import '_inlineimg' images['31-0'] alt="Neo lays on a bed in the real world, covered in needles." size="768w"}}
</div>
}!}
...
{!{
<div class="matrix-row lightbox">
   {{import '_inlineimg' images['32-1'] alt="MORPHEUS: Your appearance is now what we call 'residual self image'" size="576w"}}
   {{import '_inlineimg' images['32-2'] alt="MORPHEUS: It is the mental projectiong of your digital self." size="576w"}}
</div>
}!}
...
{!{
<div class="matrix-row lightbox">
   {{import '_inlineimg' images['33-1'] alt="NEO: I don't believe it."}}
   {{import '_inlineimg' images['33-2'] alt="NEO: It's not possible."}}
   {{import '_inlineimg' images['33-3'] alt="MORPHEUS: I didn't say it would be easy, Neo, I just said it would be the truth."}}
</div>
}!}
...
{!{
<div class="matrix-row lightbox">
   {{import '_inlineimg' images['34-1'] alt="NEO: I can't go back, can I?" size="576w"}}
   {{import '_inlineimg' images['34-2'] alt="MORPHEUS: No." size="576w"}}
</div>
<div class="matrix-row lightbox">
   {{import '_inlineimg' images['34-3'] alt="MORPHEUS: But if you could..." size="576w"}}
   {{import '_inlineimg' images['34-4'] alt="MORPHEUS: ...would you really want to?" size="576w"}}
</div>
}!}
...
{!{
<div class="matrix-row lightbox">
   {{import '_inlineimg' images['35-1'] alt="TANK: ...combat training?"}}
   {{import '_inlineimg' images['35-2'] alt="NEO: I'm going to learn Jujitsu?"}}
   {{import '_inlineimg' images['35-3'] alt="NEO: Holy shit!"}}
</div>
}!}
...
{!{
<div class="matrix-row lightbox">
   {{import '_inlineimg' images['36-0'] alt="TANK: Hey Mikey, I think he likes it." size="768w"}}
</div>
}!}
...
{!{
<div class="matrix-row lightbox">
   {{import '_inlineimg' images['37-1'] alt="MORPHEUS: Don't think you are."}}
   {{import '_inlineimg' images['37-2'] alt="MORPHEUS: Know you are."}}
   {{import '_inlineimg' images['37-3'] alt="MORPHEUS: Come on, stop trying to hit me and hit me!"}}
</div>
<div class="matrix-row lightbox">
   {{import '_inlineimg' images['37-4'] alt="MORPHEUS: You're faster than this."}}
   {{import '_inlineimg' images['37-5'] alt="NEO: I know what you're trying to do."}}
   {{import '_inlineimg' images['37-6'] alt="MORPHEUS: I'm trying to free your mind, Neo."}}
</div>
}!}
...
{!{
<div class="matrix-row lightbox">
   {{import '_inlineimg' images['38-1'] alt="MORPHEUS: You have to let it all go, Neo."}}
   {{import '_inlineimg' images['38-2'] alt="MORPHEUS: Fear, doubt and disbelief."}}
   {{import '_inlineimg' images['38-3'] alt="MORPHEUS: Free your mind."}}
</div>
<div class="matrix-row lightbox">
   {{import '_inlineimg' images['38-4'] alt="NEO: Whoa."}}
   {{import '_inlineimg' images['38-5'] alt="NEO: Okey-dokey."}}
   {{import '_inlineimg' images['38-6'] alt="NEO: Free my mind. No problem. Right."}}
</div>
}!}
...
{!{
<div class="matrix-row lightbox">
   {{import '_inlineimg' images['39-0'] alt="NEO: I thought it wasn't real? MORPHEUS: Your mind makes it real." size="768w"}}
</div>
}!}
...
{!{
<div class="matrix-row lightbox">
  {{import '_inlineimg' images['40-1'] alt="MORPHEUS: The Matrix is a system, Neo."}}
  {{import '_inlineimg' images['40-2'] alt="MORPHEUS: That system is our enemy."}}
  {{import '_inlineimg' images['40-3'] alt="MORPHEUS: Businessmen, Teachers, Lawyers, Carpenters"}}
</div>
<div class="matrix-row lightbox">
  {{import '_inlineimg' images['40-4'] alt="MORPHEUS: Most of these people are not ready to be unplugged."}}
  {{import '_inlineimg' images['40-5'] alt="MORPHEUS: But until we do, these people are part of that system..."}}
  {{import '_inlineimg' images['40-6'] alt="MORPHEUS: ...and that makes them our enemy."}}
</div>
<div class="matrix-row lightbox">
  {{import '_inlineimg' images['40-7'] alt="MORPHEUS: And many of them are so inert..."}}
  {{import '_inlineimg' images['40-8'] alt="MORPHEUS: ...so hopelessly dependent on that system..."}}
  {{import '_inlineimg' images['40-9'] alt="MORPHEUS: ...that they will fight to defend it."}}
</div>
}!}
...
{!{
<div class="matrix-row lightbox">
  {{import '_inlineimg' images['41-1'] alt="MORPHEUS: Were you listening to me, or were you looking at the woman in the red dress?"}}
  {{import '_inlineimg' images['41-2'] alt="NEO: I was-- MORPHEUS: Look again."}}
  {{import '_inlineimg' images['41-3'] alt="Neo turns around and has a gun pointed at his head."}}
</div>
}!}
...
{!{
<div class="matrix-row lightbox">
  {{import '_inlineimg' images['42-1'] alt="Neo stands in a plaza surrounded by people frozen in time as Agent Smith levels a gun at his head." size="576w"}}
  {{import '_inlineimg' images['42-2'] alt="MORPHEUS: If you are not one of us, you are one of them." size="576w"}}
</div>
}!}
...
{!{
<div class="matrix-row lightbox">
  {{import '_inlineimg' images['43-1'] alt="MORPHEUS: ...but they are the gatekeepers."}}
   {{import '_inlineimg' images['43-2'] alt="MORPHEUS: They are guarding all the doors and holding all the keys."}}
   {{import '_inlineimg' images['43-3'] alt="MORPHEUS: Sooner or later, someone will have to fight them."}}
</div>
}!}
...
{!{
<div class="matrix-row lightbox">
   {{import '_inlineimg' images['44-1'] alt="MORPHEUS: Yet their strength and their speed are still based in a world built on rules." size="576w"}}
   {{import '_inlineimg' images['44-2'] alt="MORPHEUS: They will never be as strong or as fast as you can be." size="576w"}}
</div>
}!}
...
{!{
<div class="matrix-row lightbox">
   {{import '_inlineimg' images['46-1'] alt="SMITH: Then we have a deal?"}}
   {{import '_inlineimg' images['46-2'] alt="CYPHER: And I want to be rich."}}
   {{import '_inlineimg' images['46-3'] alt="CYPHER: You know, someone important."}}
</div>
}!}
...
{!{
<div class="matrix-row lightbox">
   {{import '_inlineimg' images['47-1'] alt="MOUSE: Tastee Wheat. Did you ever try Tastee Wheat?"}}
   {{import '_inlineimg' images['47-2'] alt="MOUSE: How do the machines know what Tastee Wheat tasted like?"}}
   {{import '_inlineimg' images['47-3'] alt="MOUSE: Maybe they got it wrong?"}}
</div>
}!}
...
{!{
<div class="matrix-row lightbox">
   {{import '_inlineimg' images['48-1'] alt="NEO: I have these memories from my life."}}
   {{import '_inlineimg' images['48-2'] alt="NEO: None of them happened."}}
   {{import '_inlineimg' images['48-3'] alt="NEO: What does that mean?"}}
</div>
}!}
...
{!{
<div class="matrix-row lightbox">
   {{import '_inlineimg' images['49-1'] alt="TRINITY: The Matrix cannot tell you who you are."}}
   {{import '_inlineimg' images['49-2'] alt="NEO: But an Oracle can?"}}
   {{import '_inlineimg' images['49-3'] alt="NEO: And she's never wrong."}}
</div>
<div class="matrix-row lightbox">
   {{import '_inlineimg' images['49-4'] alt="MORPHEUS: Try not to think of it in terms of right and wrong."}}
   {{import '_inlineimg' images['49-5'] alt="MORPHEUS: She is a guide, Neo."}}
   {{import '_inlineimg' images['49-6'] alt="MORPHEUS: She can help you find the path."}}
</div>
}!}
...
{!{
<div class="matrix-row lightbox">
   {{import '_inlineimg' images['50-1'] alt="MORPHEUS: I told you that I can only show you the door." size="576w"}}
   {{import '_inlineimg' images['50-2'] alt="MORPHEUS: You have to walk through it." size="576w"}}
</div>
}!}
...
{!{
<div class="matrix-row lightbox">
   {{import '_inlineimg' images['51-1'] alt="BOY: Do not try to bend the spoon."}}
   {{import '_inlineimg' images['51-2'] alt="BOY: That's impossible."}}
   {{import '_inlineimg' images['51-3'] alt="BOY: Instead, only try to realize the truth."}}
</div>
<div class="matrix-row lightbox">
   {{import '_inlineimg' images['51-4'] alt="NEO: What truth?"}}
   {{import '_inlineimg' images['51-5'] alt="BOY: There is no spoon."}}
   {{import '_inlineimg' images['51-6'] alt="BOY: Then you'll see that it is not the spoon that bends, it is only yourself."}}
</div>
}!}
...
{!{
<div class="matrix-row lightbox">
   {{import '_inlineimg' images['52-0'] alt="ORACLE: I know you're Neo." size="768w"}}
</div>
}!}
...
{!{
<div class="matrix-row lightbox">
   {{import '_inlineimg' images['53-1'] alt="ORACLE: --and don't worry about the vase.  NEO: What vase?"}}
   {{import '_inlineimg' images['53-2'] alt="ORACLE: What's really going to bake your noodle later on is..."}}
   {{import '_inlineimg' images['53-3'] alt="ORACLE: ...would you still had broken it if I hadn't said anything?"}}
</div>
}!}
...
{!{
<div class="matrix-row lightbox">
   {{import '_inlineimg' images['54-1'] alt="ORACLE: Being the One is just like being in love."}}
   {{import '_inlineimg' images['54-2'] alt="ORACLE: No one can tell you that you're in love. You just know it..."}}
   {{import '_inlineimg' images['54-3'] alt="ORACLE: ...through and through."}}
</div>
}!}
...
{!{
<div class="matrix-row lightbox">
   {{import '_inlineimg' images['55-0'] alt="A sign above the door says Temet Nosce. ORACLE: Means, Know Thyself."}}
</div>
<div class="matrix-row lightbox">
   {{import '_inlineimg' images['54-1'] alt="ORACLE: You got the gift..."}}
   {{import '_inlineimg' images['54-2'] alt="ORACLE: ...but it looks like you're waiting for something."}}
   {{import '_inlineimg' images['54-3'] alt="ORACLE: Your next life, maybe. Who knows."}}
</div>
}!}
...
{!{
<div class="matrix-row lightbox">
   {{import '_inlineimg' images['57-1'] alt="Cypher fires a plasma torch at Tank."}}
   {{import '_inlineimg' images['57-2'] alt="CYPHER: You're a beautiful woman, Trinity."}}
   {{import '_inlineimg' images['57-3'] alt="CYPHER: Too bad things had to turn out this way."}}
</div>
<div class="matrix-row lightbox">
   {{import '_inlineimg' images['57-4'] alt="CYPHER: I'm tired of this war."}}
   {{import '_inlineimg' images['57-5'] alt="CYPHER: If you had told us the truth..."}}
   {{import '_inlineimg' images['57-6'] alt="CYPHER: We would have told you to shove that red pill up your ass!"}}
</div>
}!}
...
{!{
<div class="matrix-row lightbox">
   {{import '_inlineimg' images['58-1'] alt="SWITCH: Not like this..." size="576w"}}
   {{import '_inlineimg' images['58-2'] alt="SWITCH: Not like this." size="576w"}}
</div>
}!}
...
<div class="matrix-row lightbox">
   {{import '_inlineimg' images['59-1'] alt="SMITH: I'd like to share a revelation that I've had..."}}
   {{import '_inlineimg' images['59-2'] alt="SMITH: Human beings are a disease."}}
   {{import '_inlineimg' images['59-3'] alt="SMITH: A cancer of this planet."}}
</div>
<div class="matrix-row lightbox">
   {{import '_inlineimg' images['59-4'] alt="SMITH: You are a plague."}}
   {{import '_inlineimg' images['59-5'] alt="SMITH: And we..."}}
   {{import '_inlineimg' images['59-6'] alt="SMITH: ...are the cure!"}}
</div>
}!}
...
{!{
<div class="matrix-row lightbox">
   {{import '_inlineimg' images['60-1'] alt="Neo approaches a security check point."}}
   {{import '_inlineimg' images['60-2'] alt="GUARD: Please remove any metallic items you might be carrying. Keys, loose change."}}
   {{import '_inlineimg' images['60-3'] alt="GUARD: Holy shit!"}}
</div>
}!}
...
{!{
<div class="matrix-row lightbox">
   {{import '_inlineimg' images['61-1'] alt="JONES: Only a human."}}
   {{import '_inlineimg' images['61-2'] alt="TRINITY: Dodge this."}}
   {{import '_inlineimg' images['61-3'] alt="Jones goes flying backwards from a bullet to the head."}}
</div>
}!}
...
{!{
<div class="matrix-row lightbox">
   {{import '_inlineimg' images['62-1'] alt="A raging fireball tears through the lobby of the building."}}
   {{import '_inlineimg' images['62-2'] alt="The agents stand in front of a handcuffed Morpheus as the sprinklers rain down on them."}}
   {{import '_inlineimg' images['62-3'] alt="Neo astride a fireing minigun on the side of a helecopter."}}
</div>
<div class="matrix-row lightbox">
   {{import '_inlineimg' images['62-4'] alt="View from directly under the helecopter as bullet casings and ribbon chaff fall from the gun."}}
   {{import '_inlineimg' images['62-5'] alt="Smith kneels in the water, firing his pistol as a trail of bullet impact from the minigun snakes towards him."}}
   {{import '_inlineimg' images['62-6'] alt="View looking up at the helecopter as bullet cases fall towards the camera."}}
</div>
}!}
...
{!{
<div class="matrix-row lightbox">
   {{import '_inlineimg' images['63-1'] alt="NEO: [The Oracle] told me--  MORPHEUS: She told you..." size="576w"}}
   {{import '_inlineimg' images['63-2'] alt="MORPHEUS: ...what you needed to hear." size="576w"}}
</div>
<div class="matrix-row lightbox">
   {{import '_inlineimg' images['63-3'] alt="MORPHEUS: ...there's a difference between knowing the path..." size="576w"}}
   {{import '_inlineimg' images['63-1'] alt="MORPHEUS: ...and walking the path." size="576w"}}
</div>
}!}
...
{!{
<div class="matrix-row lightbox">
   {{import '_inlineimg' images['64-1'] alt="TRINITY: Neo, I want to tell you something..." size="576w"}}
   {{import '_inlineimg' images['64-2'] alt="TRINITY: ...but I'm afraid of what it could mean if I do." size="576w"}}
</div>
}!}
...
{!{
<div class="matrix-row lightbox">
   {{import '_inlineimg' images['65-1'] alt="Neo and Smith fly at each other in subway station, handguns drawn, firing bullets past one another."}}
   {{import '_inlineimg' images['65-2'] alt="SMITH: You're empty!"}}
   {{import '_inlineimg' images['65-3'] alt="NEO: So are you."}}
</div>
}!}
...
{!{
<div class="matrix-row lightbox">
   {{import '_inlineimg' images['66-2'] alt="SMITH: You hear that Mr. Anderson?" size="576w"}}
   {{import '_inlineimg' images['66-3'] alt="SMITH: That is the sound of inevitability." size="576w"}}
</div>
<div class="matrix-row lightbox">
   {{import '_inlineimg' images['66-4'] alt="SMITH: It is the sound of your death." size="576w"}}
   {{import '_inlineimg' images['66-5'] alt="SMITH: Goodbye, Mr. Anderson" size="576w"}}
</div>
<div class="matrix-row lightbox">
   {{import '_inlineimg' images['66-6'] alt="NEO: My name..." size="576w"}}
   {{import '_inlineimg' images['66-7'] alt="NEO: ...is Neo." size="576w"}}
</div>
<div class="matrix-row lightbox">
   {{import '_inlineimg' images['66-8'] alt="Neo backwards flips off of the subway tracks, leaving Smith behind as a train bears down on them." size="576w"}}
   {{import '_inlineimg' images['66-9'] alt="Smith stares at the train in rage as it collides with him." size="576w"}}
</div>
}!}
...
{!{
<div class="matrix-row lightbox">
   {{import '_inlineimg' images['67-1'] alt="Smith surprises Neo as he opens the door to a room with a phone, and fires his entire clip into Neo's chest"}}
   {{import '_inlineimg' images['67-2'] alt="NEO: No."}}
   {{import '_inlineimg' images['67-3'] alt="All three agents fire their guns down the hallway towards Neo, fireing range style."}}
</div>
<div class="matrix-row lightbox">
   {{import '_inlineimg' images['67-4'] alt="Neo holds out his hand as the bullets approach, causing them to slow mid air."}}
   {{import '_inlineimg' images['67-5'] alt="Neo plucks one of the stopped bullets out of the air and examines it."}}
   {{import '_inlineimg' images['67-6'] alt="Looking down the hallway, Neo now sees the world as it really is, a simulation, built from symbolism."}}
</div>
<div class="matrix-row lightbox">
   {{import '_inlineimg' images['67-7'] alt="Neo leaps into Smith's chest, absorbing into Smith."}}
   {{import '_inlineimg' images['67-8'] alt="Smith fractures and shatters as Neo explodes outwards from within."}}
   {{import '_inlineimg' images['67-9'] alt="The other agents look on as chunks of Smith fly past them while a reformed Neo stands in the hallway."}}
</div>
}!}
...
{!{
<div class="matrix-row lightbox">
   {{import '_inlineimg' images['68-0'] alt="A screen of rolling digits attempting to trace the origin of Neo's phone call. The words SYSTEM ERROR appear in the center." size="768w"}}
</div>
}!}
...
{!{
<div class="matrix-row lightbox">
   {{import '_inlineimg' images['69-0'] alt="Written and Directed by The Wachowski Brothers" size="768w"}}
</div>
}!}
