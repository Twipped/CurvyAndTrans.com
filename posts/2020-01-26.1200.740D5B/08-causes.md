...
^^^<!--[--><div class="card borderless right span3"><strong style="display: block;text-align: center;">And it gets even weirder!</strong>{!{ {{> tweets ids=(array
  '1224039568971710464'
  '1224040716365524993'
  '1224041800513380352'
  '1224041800513380352'
  ...
  '1224043995413639168'
  '1224044949160611840'
) tweets=meta.tweets className="collapse hide-reply" }} }!}</div><!--]-->^^^
...
^^^<!--[-->{!{
  ...
  {{> tweets ids=(array
    ...
    '1207838924263084033'
    '1207839452619522048'
  ) tweets=meta.tweets className="oneblock card right span3" }}
  {{> tweets ids=(array
    '1208181235593490433'
  ) tweets=meta.tweets className="card right span3" }}
}!}<!--]-->^^^
