...
<div class="card right span4" style="margin-top: 0">
  ...
  <div class="list-group list-group-flush">
    ...
    <a class="list-group-item active" href="01-euphoria.html">Euphoria</a>
...
^^^<ul class="nav nav-fill pager">
  <li class="nav-item">
    <a href="index.html" class="btn btn-info btn-arrow-left">What is Gender Dysphoria</a>
  </li>
  <li class="nav-item">
    <a href="02-physical-biochemical.html" class="btn btn-primary btn-arrow-right">Physical &amp; Biochemical Dysphoria</a>
  </li>
</ul>^^^
